...
class _AbaConversasState extends State<AbaConversas> {
  ...
  void initState() {
    ...
    conversa.caminhoFoto = "https://firebasestorage.googleapis.com/v0/b/whatsapp-979fa.appspot.com/o/perfil%2Fperfil1.jpg?alt=media&token=239f9aab-8139-4bbd-bae4-9f19753ccde8";
          ...
          case ConnectionState.done:
            if(snapshot.hasError){
              ...
              if(querySnapshot.documents.length == 0){
                return Center(
                  child: Text(
                    "Você não tem nehuma mensagem ainda.",
                    style: TextStyle(
                      fontSize: 18,
