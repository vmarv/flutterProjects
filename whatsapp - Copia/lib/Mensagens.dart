...
class _MensagensState extends State<Mensagens> {
  ...
  _salvarMensagem(String idRemetente, String idDestinatario, Mensagem msg) async {
    ...
    await db.collection("mensagens").document(idRemetente)
  ...
  Stream<QuerySnapshot> _adicionarListenerMensagens() {
    ...
    final stream =db.collection("mensagens").document(_idUsuarioLogado)
    ...
    var caixaMensagem = Container(
      ...
      child: Row(
        children: <Widget>[
          ...
          Platform.isIOS
              ? CupertinoButton(child: Text("Enviar"), onPressed: _enviarMensagem,)
